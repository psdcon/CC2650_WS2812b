...
void ti_sysbios_knl_Task_schedule__I()
{
...
void ti_sysbios_knl_Task_enter__I()
{
...
Int ti_sysbios_knl_Task_Module_startup__E (Int phase)
{
...
void ti_sysbios_knl_Task_startup__E()
{
...
void ti_sysbios_knl_Task_startCore__E(UInt coreId)
{
    ti_sysbios_knl_Queue_Handle maxQ;
    ti_sysbios_knl_Task_Object *prevTask;
...
UInt ti_sysbios_knl_Task_disable__E()
{
...
void ti_sysbios_knl_Task_enable__E()
{
...
void ti_sysbios_knl_Task_restore__E(UInt tskKey)
{
    if (tskKey == 0) {
        _set_interrupt_priority((ti_sysbios_family_arm_m3_Hwi_disablePriority__C));
        if (((ti_sysbios_knl_Task_Module_State *)((&(ti_sysbios_knl_Task_Module__state__V))))->workFlag
...
void ti_sysbios_knl_Task_restoreHwi__E(UInt tskKey)
{
    if (tskKey == 0) {
        if (((ti_sysbios_knl_Task_Module_State *)((&(ti_sysbios_knl_Task_Module__state__V))))->workFlag
            && (!(1) || ((1) && ti_sysbios_knl_Swi_enabled__E()))) {
...
ti_sysbios_knl_Task_Handle ti_sysbios_knl_Task_self__E()
{
...
void ti_sysbios_knl_Task_processVitalTaskFlag__I(ti_sysbios_knl_Task_Object *tsk)
{
    UInt hwiKey;
...
void ti_sysbios_knl_Task_exit__E()
{
    UInt tskKey, hwiKey;
...
void ti_sysbios_knl_Task_sleepTimeout__I(UArg arg)
{
    UInt hwiKey;
...
void ti_sysbios_knl_Task_sleep__E(UInt32 timeout)
{
...
void ti_sysbios_knl_Task_yield__E()
{
    UInt tskKey, hwiKey;
...
Int ti_sysbios_knl_Task_Instance_init__E(ti_sysbios_knl_Task_Object *tsk, ti_sysbios_knl_Task_FuncPtr fxn,
...
Int ti_sysbios_knl_Task_postInit__I(ti_sysbios_knl_Task_Object *tsk, xdc_runtime_Error_Block *eb)
{
    UInt tskKey, hwiKey;
    ti_sysbios_knl_Queue_Handle readyQ;
...
void ti_sysbios_knl_Task_Instance_finalize__E(ti_sysbios_knl_Task_Object *tsk, Int status)
{
...
void ti_sysbios_knl_Task_blockI__E(ti_sysbios_knl_Task_Object *tsk)
{
...
void ti_sysbios_knl_Task_unblock__E(ti_sysbios_knl_Task_Object *tsk)
{
    UInt hwiKey;
...
void ti_sysbios_knl_Task_unblockI__E(ti_sysbios_knl_Task_Object *tsk, UInt hwiKey)
{
...
void ti_sysbios_knl_Task_allBlockedFunction__I()
{
    volatile UInt delay;
...
void ti_sysbios_knl_Task_deleteTerminatedTasksFunc__I()
{
    UInt hwiKey, taskKey;
