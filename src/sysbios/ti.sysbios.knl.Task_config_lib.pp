...
void ti_sysbios_knl_Task_Params__init__S( xdc_Ptr prms, const void *src, xdc_SizeT psz, xdc_SizeT isz ) 
{
...
void ti_sysbios_knl_Task_Object__destruct__S( xdc_Ptr obj ) 
{
...
void ti_sysbios_knl_Task_Object__delete__S( xdc_Ptr instp ) 
{
