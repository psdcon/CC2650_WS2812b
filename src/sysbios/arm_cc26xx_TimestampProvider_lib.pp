...
Int ti_sysbios_family_arm_cc26xx_TimestampProvider_Module_startup__E( Int phase )
{
...
void ti_sysbios_family_arm_cc26xx_TimestampProvider_get64__E(xdc_runtime_Types_Timestamp64 *result)
{
    UInt64 time;
...
void ti_sysbios_family_arm_cc26xx_TimestampProvider_getFreq__E(xdc_runtime_Types_FreqHz *freq)
{
