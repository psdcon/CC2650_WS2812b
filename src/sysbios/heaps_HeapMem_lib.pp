...
void ti_sysbios_heaps_HeapMem_init__I()
{
    Int i;
...
void ti_sysbios_heaps_HeapMem_Instance_init__E(ti_sysbios_heaps_HeapMem_Object *obj, const ti_sysbios_heaps_HeapMem_Params *params)
{
...
void ti_sysbios_heaps_HeapMem_restore__E(ti_sysbios_heaps_HeapMem_Object *obj)
{
...
Ptr ti_sysbios_heaps_HeapMem_alloc__E(ti_sysbios_heaps_HeapMem_Object *obj, SizeT reqSize,
...
void ti_sysbios_heaps_HeapMem_free__E(ti_sysbios_heaps_HeapMem_Object *obj, Ptr addr, SizeT size)
{
    IArg key;
...
Bool ti_sysbios_heaps_HeapMem_isBlocking__E(ti_sysbios_heaps_HeapMem_Object *obj)
{
...
void ti_sysbios_heaps_HeapMem_getStats__E(ti_sysbios_heaps_HeapMem_Object *obj, xdc_runtime_Memory_Stats *stats)
{
    IArg key;
