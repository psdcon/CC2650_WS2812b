...
void ti_sysbios_knl_Semaphore_Instance_init__E(ti_sysbios_knl_Semaphore_Object *sem, Int count,
...
void ti_sysbios_knl_Semaphore_Instance_finalize__E(ti_sysbios_knl_Semaphore_Object *sem)
{
    ti_sysbios_knl_Queue_Handle pendQ;
...
void ti_sysbios_knl_Semaphore_pendTimeout__I(UArg arg)
{
    UInt hwiKey;
...
Bool ti_sysbios_knl_Semaphore_pend__E(ti_sysbios_knl_Semaphore_Object *sem, UInt32 timeout)
{
    UInt hwiKey, tskKey;
...
void ti_sysbios_knl_Semaphore_post__E(ti_sysbios_knl_Semaphore_Object *sem)
{
    UInt tskKey, hwiKey;
    ti_sysbios_knl_Semaphore_PendElem *elem;
    ti_sysbios_knl_Queue_Handle pendQ;
