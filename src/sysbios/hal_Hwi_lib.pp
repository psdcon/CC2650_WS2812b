...
Int ti_sysbios_hal_Hwi_Module_startup__E(Int phase)
{
...
UInt ti_sysbios_hal_Hwi_disableInterrupt__E(UInt intNum)
{
...
UInt ti_sysbios_hal_Hwi_enableInterrupt__E(UInt intNum)
{
...
Bool ti_sysbios_hal_Hwi_getStackInfo__E(ti_sysbios_hal_Hwi_StackInfo *stkInfo, Bool computeStackDepth)
{
...
void ti_sysbios_hal_Hwi_switchFromBootStack__E()
{
...
Int ti_sysbios_hal_Hwi_Instance_init__E(ti_sysbios_hal_Hwi_Object *hwi, Int intNum, ti_sysbios_hal_Hwi_FuncPtr fxn, const ti_sysbios_hal_Hwi_Params *params, xdc_runtime_Error_Block *eb)
{
...
void ti_sysbios_hal_Hwi_Instance_finalize__E(ti_sysbios_hal_Hwi_Object *hwi, Int status)
{
