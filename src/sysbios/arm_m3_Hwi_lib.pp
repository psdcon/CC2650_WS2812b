...
Int ti_sysbios_family_arm_m3_Hwi_Module_startup__E(Int phase)
{
    int i;
...
Int ti_sysbios_family_arm_m3_Hwi_Instance_init__E(ti_sysbios_family_arm_m3_Hwi_Object *hwi, Int intNum,
...
Int ti_sysbios_family_arm_m3_Hwi_postInit__I (ti_sysbios_family_arm_m3_Hwi_Object *hwi, xdc_runtime_Error_Block *eb)
{
    UInt intNum;
...
void ti_sysbios_family_arm_m3_Hwi_Instance_finalize__E(ti_sysbios_family_arm_m3_Hwi_Object *hwi, Int status)
{
    UInt intNum;
...
void ti_sysbios_family_arm_m3_Hwi_initNVIC__E()
{
    UInt intNum;
    UInt32 *ramVectors;
...
void ti_sysbios_family_arm_m3_Hwi_startup__E()
{
...
UInt ti_sysbios_family_arm_m3_Hwi_disableFxn__E()
{
...
UInt ti_sysbios_family_arm_m3_Hwi_enableFxn__E()
{
...
void ti_sysbios_family_arm_m3_Hwi_restoreFxn__E(UInt key)
{
...
void ti_sysbios_family_arm_m3_Hwi_plug__E(UInt intNum, void *fxn)
{
    UInt32 *func;
...
void ti_sysbios_family_arm_m3_Hwi_switchFromBootStack__E()
{
...
Bool ti_sysbios_family_arm_m3_Hwi_getStackInfo__E(ti_sysbios_family_arm_m3_Hwi_StackInfo *stkInfo, Bool computeStackDepth)
{
    Char *isrSP;
    Bool stackOverflow;
...
void ti_sysbios_family_arm_m3_Hwi_setPriority__E(UInt intNum, UInt priority)
{
...
void ti_sysbios_family_arm_m3_Hwi_excHandler__I(UInt *excStack, UInt lr)
{
...
UInt ti_sysbios_family_arm_m3_Hwi_dispatchC__I(ti_sysbios_family_arm_m3_Hwi_Irp irp, UInt32 dummy1, UInt32 dummy2, ti_sysbios_family_arm_m3_Hwi_Object *hwi)
{
...
void ti_sysbios_family_arm_m3_Hwi_doSwiRestore__I(UInt swiTskKey)
{
...
void ti_sysbios_family_arm_m3_Hwi_doTaskRestore__I(UInt swiTskKey)
{
