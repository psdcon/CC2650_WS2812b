...
void ti_sysbios_knl_Queue_Instance_init__E(ti_sysbios_knl_Queue_Object *obj, const ti_sysbios_knl_Queue_Params *params)
{
...
Ptr ti_sysbios_knl_Queue_dequeue__E(ti_sysbios_knl_Queue_Object *obj)
{
    ti_sysbios_knl_Queue_Elem *elem;
...
Bool ti_sysbios_knl_Queue_empty__E(ti_sysbios_knl_Queue_Object *obj)
{
...
void ti_sysbios_knl_Queue_enqueue__E(ti_sysbios_knl_Queue_Object *obj, ti_sysbios_knl_Queue_Elem *elem)
{
...
Ptr ti_sysbios_knl_Queue_get__E(ti_sysbios_knl_Queue_Object *obj)
{
    ti_sysbios_knl_Queue_Elem *elem;
    UInt key;
...
Ptr ti_sysbios_knl_Queue_head__E(ti_sysbios_knl_Queue_Object *obj)
{
...
void ti_sysbios_knl_Queue_elemClear__E(ti_sysbios_knl_Queue_Elem *qelem)
{
...
Ptr ti_sysbios_knl_Queue_next__E(ti_sysbios_knl_Queue_Elem *qelem)
{
    return (qelem->next);
}
...
void ti_sysbios_knl_Queue_put__E(ti_sysbios_knl_Queue_Object *obj, ti_sysbios_knl_Queue_Elem *elem)
{
    UInt key;
...
void ti_sysbios_knl_Queue_remove__E(ti_sysbios_knl_Queue_Elem *qelem) 
{
