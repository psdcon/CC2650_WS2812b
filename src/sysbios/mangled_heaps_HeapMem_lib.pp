# 1 "C:/ti/tirtos_simplelink_2_13_00_06/products/bios_6_42_00_08/packages/ti/sysbios/heaps/HeapMem.c"
...
# 37 "C:/ti/tirtos_simplelink_2_13_00_06/products/bios_6_42_00_08/packages/ti/sysbios/heaps/HeapMem.c"
...
# 38 "C:/ti/tirtos_simplelink_2_13_00_06/products/bios_6_42_00_08/packages/ti/sysbios/heaps/HeapMem.c"
...
# 39 "C:/ti/tirtos_simplelink_2_13_00_06/products/bios_6_42_00_08/packages/ti/sysbios/heaps/HeapMem.c"
...
# 40 "C:/ti/tirtos_simplelink_2_13_00_06/products/bios_6_42_00_08/packages/ti/sysbios/heaps/HeapMem.c"
# 1 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Memory.h"
...
# 41 "C:/ti/tirtos_simplelink_2_13_00_06/products/bios_6_42_00_08/packages/ti/sysbios/heaps/HeapMem.c"
...
# 42 "C:/ti/tirtos_simplelink_2_13_00_06/products/bios_6_42_00_08/packages/ti/sysbios/heaps/HeapMem.c"

# 1 "C:\\ti\\tirtos_simplelink_2_13_00_06\\products\\bios_6_42_00_08\\packages\\ti\\sysbios\\heaps\\package/internal/HeapMem.xdc.h"
...
# 595 "C:/ti/tirtos_simplelink_2_13_00_06/products/bios_6_42_00_08/packages/ti/sysbios/heaps/HeapMem.h"
...
# 347 "C:/ti/tirtos_simplelink_2_13_00_06/products/bios_6_42_00_08/packages/ti/sysbios/heaps/package/HeapMem_Module_GateProxy.h"
...
# 404 "C:/ti/tirtos_simplelink_2_13_00_06/products/bios_6_42_00_08/packages/ti/sysbios/heaps/package/HeapMem_Module_GateProxy.h"

# 598 "C:/ti/tirtos_simplelink_2_13_00_06/products/bios_6_42_00_08/packages/ti/sysbios/heaps/HeapMem.h"

# 16 "C:\\ti\\tirtos_simplelink_2_13_00_06\\products\\bios_6_42_00_08\\packages\\ti\\sysbios\\heaps\\package/internal/HeapMem.xdc.h"

# 23 "C:\\ti\\tirtos_simplelink_2_13_00_06\\products\\bios_6_42_00_08\\packages\\ti\\sysbios\\heaps\\package/internal/HeapMem.xdc.h"
...
# 108 "C:\\ti\\tirtos_simplelink_2_13_00_06\\products\\bios_6_42_00_08\\packages\\ti\\sysbios\\heaps\\package/internal/HeapMem.xdc.h"

 
# 1 "Error_inconsistent_object_size_in_ti.sysbios.heaps.HeapMem"
...
# 44 "C:/ti/tirtos_simplelink_2_13_00_06/products/bios_6_42_00_08/packages/ti/sysbios/heaps/HeapMem.c"



 
void ti_sysbios_heaps_HeapMem_init__I__mangled__()
{
    Int i;
    ...
    for (i = 0; i < ti_sysbios_heaps_HeapMem_Object__count__C; i++) {
        obj = ti_sysbios_heaps_HeapMem_Object_get(0, i);
        ...
        obj->buf = (Char *)xdc_uargToPtr(((xdc_runtime_Memory_Size)(obj->buf) + (obj->align - 1)) &
                            ~(obj->align - 1));

         
        ti_sysbios_heaps_HeapMem_restore__E(obj);
    }
}
...
void ti_sysbios_heaps_HeapMem_Instance_init__E__mangled__(ti_sysbios_heaps_HeapMem_Object *obj, const ti_sysbios_heaps_HeapMem_Params *params)
{
    xdc_runtime_Memory_Size offset;
    SizeT       bufAlign;
    ...
    if (params->minBlockAlign <= (ti_sysbios_heaps_HeapMem_reqAlign__C)) {
        obj->minBlockAlign = (ti_sysbios_heaps_HeapMem_reqAlign__C);
        bufAlign = (ti_sysbios_heaps_HeapMem_reqAlign__C);
    }
    else {
    ...
    if ((offset = (xdc_runtime_Memory_Size)(obj->buf) & (bufAlign - 1)) != 0) {
...
void ti_sysbios_heaps_HeapMem_restore__E__mangled__(ti_sysbios_heaps_HeapMem_Object *obj)
{
    ti_sysbios_heaps_HeapMem_Header *begHeader;
    ...
    begHeader = (ti_sysbios_heaps_HeapMem_Header *)(obj->buf);
    begHeader->next = 0;
...
Ptr ti_sysbios_heaps_HeapMem_alloc__E__mangled__(ti_sysbios_heaps_HeapMem_Object *obj, SizeT reqSize,
                    SizeT reqAlign, xdc_runtime_Error_Block *eb)
{
    IArg key;
    ti_sysbios_heaps_HeapMem_Header *prevHeader, *newHeader, *curHeader;
    Char *allocAddr;
    xdc_runtime_Memory_Size curSize, adjSize;
    SizeT remainSize;  
    ...
    adjSize = (xdc_runtime_Memory_Size)reqSize;
    ...
    key = ti_sysbios_heaps_HeapMem_Module_GateProxy_enter__E(ti_sysbios_heaps_HeapMem_Module__gateObj__C);
    ...
    while (curHeader != 0) {
        ...
        offset = (xdc_runtime_Memory_Size)curHeader & (adjAlign - 1);
        if (offset) {
        ...
        if (curSize >= (adjSize + offset)) {
            ...
            allocAddr = (Char *)xdc_uargToPtr((xdc_runtime_Memory_Size)curHeader + offset);
            ...
            if (offset) {
                ...
                if (remainSize) {
                    newHeader = (ti_sysbios_heaps_HeapMem_Header *)
                        xdc_uargToPtr(((xdc_runtime_Memory_Size)allocAddr + adjSize));
            ...
            ti_sysbios_heaps_HeapMem_Module_GateProxy_leave__E(ti_sysbios_heaps_HeapMem_Module__gateObj__C, (key));
    ...
    xdc_runtime_Error_raiseX__E((eb), ti_sysbios_heaps_HeapMem_Module__id__C, 0, 307, ((ti_sysbios_heaps_HeapMem_E_memory__C)), (IArg)((IArg)obj), (IArg)((IArg)reqSize));;
...
void ti_sysbios_heaps_HeapMem_free__E__mangled__(ti_sysbios_heaps_HeapMem_Object *obj, Ptr addr, SizeT size)
{
    IArg key;
    ti_sysbios_heaps_HeapMem_Header *curHeader, *newHeader, *nextHeader;
    SizeT offset;
    ...
    newHeader = (ti_sysbios_heaps_HeapMem_Header *)addr;
    ...
    while (nextHeader != 0 && nextHeader < newHeader) {
    ...
    if (nextHeader != 0) {
        ...
        if (((xdc_runtime_Memory_Size)newHeader + size) == (xdc_runtime_Memory_Size)nextHeader) {
    ...
    if ((curHeader != &obj->head) &&
        (((xdc_runtime_Memory_Size)curHeader + curHeader->size) == (xdc_runtime_Memory_Size)newHeader)) {
...
Bool ti_sysbios_heaps_HeapMem_isBlocking__E__mangled__(ti_sysbios_heaps_HeapMem_Object *obj)
{
    return (ti_sysbios_heaps_HeapMem_Module_GateProxy_query__E((1)));
}



 
void ti_sysbios_heaps_HeapMem_getStats__E__mangled__(ti_sysbios_heaps_HeapMem_Object *obj, xdc_runtime_Memory_Stats *stats)
{
    IArg key;
    ti_sysbios_heaps_HeapMem_Header *curHeader;
...
void ti_sysbios_heaps_HeapMem_getExtendedStats__E(ti_sysbios_heaps_HeapMem_Object *obj, ti_sysbios_heaps_HeapMem_ExtendedStats *stats)
{
    stats->buf   = obj->buf;
...
IArg ti_sysbios_heaps_HeapMem_enter__E()
{
    return (ti_sysbios_heaps_HeapMem_Module_GateProxy_enter__E(ti_sysbios_heaps_HeapMem_Module__gateObj__C));
}
...
void ti_sysbios_heaps_HeapMem_leave__E(IArg key)
{
    ti_sysbios_heaps_HeapMem_Module_GateProxy_leave__E(ti_sysbios_heaps_HeapMem_Module__gateObj__C, (key));
}
