...
void ti_sysbios_gates_GateHwi_Instance_init__E(ti_sysbios_gates_GateHwi_Object *gate,
...
IArg ti_sysbios_gates_GateHwi_enter__E(ti_sysbios_gates_GateHwi_Object *obj)
{
...
void ti_sysbios_gates_GateHwi_leave__E(ti_sysbios_gates_GateHwi_Object *obj, IArg key)
{
...
Bool ti_sysbios_gates_GateHwi_query__E(Int qual)
{
    return (0);
}
