# 1 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Registry.c"
...
# 5 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Registry.c"
...
# 6 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Registry.c"
...
#pragma diag_pop
# 7 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Registry.c"

# 1 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Registry.xdc.h"
...
# 16 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Registry.xdc.h"

# 23 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Registry.xdc.h"
...
# 123 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Registry.xdc.h"


# 9 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Registry.c"
...
xdc_runtime_Registry_Result xdc_runtime_Registry_addModule__E(xdc_runtime_Registry_Desc *desc, CString modName)
{   
     
    if (xdc_runtime_Registry_findByName__E(modName) != 0) {
        return (xdc_runtime_Registry_ALREADY_ADDED);
    }
    
     
    if (((xdc_runtime_Registry_Module_State *)((&(xdc_runtime_Registry_Module__state__V))))->curId == ((xdc_runtime_Text_unnamedModsLastId__C) + 1)) {
        return (xdc_runtime_Registry_ALL_IDS_USED);
    }
    
     
    
     
    desc->id = ((xdc_runtime_Registry_Module_State *)((&(xdc_runtime_Registry_Module__state__V))))->curId--;
    ...
    desc->mask = xdc_runtime_Registry_Module_getMask();
    
     
    desc->next = ((xdc_runtime_Registry_Module_State *)((&(xdc_runtime_Registry_Module__state__V))))->listHead;
    ((xdc_runtime_Registry_Module_State *)((&(xdc_runtime_Registry_Module__state__V))))->listHead = desc;
        
    return (xdc_runtime_Registry_SUCCESS);
}



 
xdc_runtime_Registry_Desc *xdc_runtime_Registry_findByName__E(CString name)
{
    return (xdc_runtime_Registry_findByNameInList__I(name, ((xdc_runtime_Registry_Module_State *)((&(xdc_runtime_Registry_Module__state__V))))->listHead));
}



 
xdc_runtime_Registry_Desc *xdc_runtime_Registry_findByNameInList__I(CString name,
    xdc_runtime_Registry_Desc *listHead)
{
    xdc_runtime_Registry_Desc *dp;

    for (dp = listHead; dp != 0; dp = dp->next) {
...
xdc_runtime_Registry_Desc *xdc_runtime_Registry_findByNamePattern__E(CString namePat, Int len,
    xdc_runtime_Registry_Desc *prev)
{
    xdc_runtime_Registry_Desc *dp;
    ...
    if (prev == 0) {
        dp = ((xdc_runtime_Registry_Module_State *)((&(xdc_runtime_Registry_Module__state__V))))->listHead;
    }
    ...
    for (; dp != 0; dp = dp->next) {
        ...
        if (xdc_runtime_Registry_matchPattern__I(namePat, len, dp->modName)) {
            return (dp);
        }
    }
...
Bool xdc_runtime_Registry_matchPattern__I(CString pattern, Int len, CString modName)
{
...
xdc_runtime_Registry_Desc *xdc_runtime_Registry_findById__E(xdc_runtime_Types_ModuleId mid)
{
    ...
    for (dp = ((xdc_runtime_Registry_Module_State *)((&(xdc_runtime_Registry_Module__state__V))))->listHead; dp != 0; dp = dp->next) {
        if (dp->id == mid) {
            return (dp);
        }
    }
...
Bool xdc_runtime_Registry_getMask__E(CString name, xdc_runtime_Types_DiagsMask *mask)
{
    xdc_runtime_Registry_Desc *dp = xdc_runtime_Registry_findByName__E(name);
...
Bool xdc_runtime_Registry_isMember__E(xdc_runtime_Types_ModuleId mid)
{
    return (mid <= (xdc_runtime_Text_registryModsLastId__C) && mid >= ((xdc_runtime_Text_unnamedModsLastId__C) + 1));
}
...
{
    if (desc == 0) {
        return (((xdc_runtime_Registry_Module_State *)((&(xdc_runtime_Registry_Module__state__V))))->listHead);
    }
    else {
        return (desc->next);
    }
...
CString xdc_runtime_Registry_getModuleName__E(xdc_runtime_Registry_Desc *desc)
{
    return (desc->modName);
}
