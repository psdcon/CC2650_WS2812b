...
Ptr xdc_runtime_Core_createObject__I(const xdc_runtime_Core_ObjDesc *od, Ptr curObj, Ptr resPrms,
...
void xdc_runtime_Core_deleteObject__I(const xdc_runtime_Core_ObjDesc *od, Ptr curObj, Fxn finalFxn,
