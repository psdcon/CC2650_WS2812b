...
void ti_sysbios_knl_Swi_run__I(ti_sysbios_knl_Swi_Object *swi)
{
...
void ti_sysbios_knl_Swi_runLoop__I()
{
...
void ti_sysbios_knl_Swi_schedule__I()
{
    ti_sysbios_knl_Queue_Handle curQ, maxQ;
    UInt hwiKey;
    UInt tskKey;
...
Int ti_sysbios_knl_Swi_Module_startup__E(Int phase)
{
...
void ti_sysbios_knl_Swi_startup__E()
{
...
Bool ti_sysbios_knl_Swi_enabled__E()
{
...
UInt ti_sysbios_knl_Swi_disable__E()
{
...
void ti_sysbios_knl_Swi_restore__E(UInt swiKey)
{
    UInt hwiKey;
...
void ti_sysbios_knl_Swi_restoreHwi__E(UInt swiKey)
{
    ti_sysbios_knl_Queue_Handle curQ, maxQ;
    ti_sysbios_knl_Swi_Object *swi;
...
Int ti_sysbios_knl_Swi_Instance_init__E(ti_sysbios_knl_Swi_Object *swi, ti_sysbios_knl_Swi_FuncPtr fxn,
...
Int ti_sysbios_knl_Swi_postInit__I (ti_sysbios_knl_Swi_Object *swi, xdc_runtime_Error_Block *eb)
{
...
void ti_sysbios_knl_Swi_Instance_finalize__E(ti_sysbios_knl_Swi_Object *swi, Int status)
{
...
void ti_sysbios_knl_Swi_post__E(ti_sysbios_knl_Swi_Object *swi)
{
    UInt hwiKey;
    UInt swiKey;
