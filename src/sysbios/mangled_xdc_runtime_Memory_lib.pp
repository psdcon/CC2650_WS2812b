# 1 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Memory.c"
...
# 18 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Memory.c"
...
# 19 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Memory.c"
# 1 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/IHeap.h"
...
# 20 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Memory.c"

# 1 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Memory.xdc.h"
...
# 16 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Memory.xdc.h"

# 23 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Memory.xdc.h"
...
# 106 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Memory.xdc.h"


# 22 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Memory.c"
...
#pragma diag_pop
# 24 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Memory.c"
...
Ptr xdc_runtime_Memory_alloc__E__mangled__(xdc_runtime_IHeap_Handle heap, SizeT size, SizeT align, xdc_runtime_Error_Block *eb)
{
    Ptr block;
    Bool prior = xdc_runtime_Error_check__E(eb);
    
     
    if (align == 0) {
        align = xdc_runtime_Memory_getMaxDefaultTypeAlign__E();
    }

     
    block = xdc_runtime_Memory_HeapProxy_alloc__E(heap ? heap : (xdc_runtime_Memory_defaultHeapInstance__C), 
                        size, align, eb);
    ...
    if (block == 0 && (prior || !xdc_runtime_Error_check__E(eb))) {
        xdc_runtime_Error_raiseX__E((eb), xdc_runtime_Memory_Module__id__C, 0, 52, ((xdc_runtime_Error_E_memory__C)), (IArg)((IArg)heap), (IArg)((IArg)size));;
    }
...
Ptr xdc_runtime_Memory_calloc__E__mangled__(xdc_runtime_IHeap_Handle heap, SizeT size, SizeT align, xdc_runtime_Error_Block *eb)
{
     
    return (xdc_runtime_Memory_valloc__E(heap, size, align, 0, eb));
}



 
void xdc_runtime_Memory_getStats__E(xdc_runtime_IHeap_Handle heap, xdc_runtime_Memory_Stats *stats)
{
    xdc_runtime_Memory_HeapProxy_getStats__E(heap ? heap : (xdc_runtime_Memory_defaultHeapInstance__C), stats);
}



 
SizeT xdc_runtime_Memory_getMaxDefaultTypeAlign__E__mangled__(void)
{
    return (((xdc_runtime_Memory_Module_State *)((&(xdc_runtime_Memory_Module__state__V))))->maxDefaultTypeAlign);
}



 
void xdc_runtime_Memory_free__E__mangled__(xdc_runtime_IHeap_Handle heap, Ptr block, SizeT size)
{
    xdc_runtime_Memory_HeapProxy_free__E(
        heap ? heap : (xdc_runtime_Memory_defaultHeapInstance__C), block, size);
}



 
Bool xdc_runtime_Memory_query__E(xdc_runtime_IHeap_Handle heap, Int qual)
{
    Bool flag = 0;
    
    switch (qual) {
        case (1):
            flag = xdc_runtime_Memory_HeapProxy_isBlocking__E(
                heap ? heap : (xdc_runtime_Memory_defaultHeapInstance__C));
            break;
        default: 
            break;
    }
...
Ptr xdc_runtime_Memory_valloc__E__mangled__(xdc_runtime_IHeap_Handle heap, SizeT size, SizeT align, Char value, 
                  xdc_runtime_Error_Block *eb)
{
    Ptr block = xdc_runtime_Memory_alloc__E(heap, size, align, eb);
    if (block != 0) {
