# 1 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Startup.c"
...
# 18 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Startup.c"
# 1 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Startup.xdc.h"
...
# 16 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Startup.xdc.h"

# 23 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Startup.xdc.h"
...
# 95 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Startup.xdc.h"


# 19 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Startup.c"



 
void xdc_runtime_Startup_exec__E__mangled__()
{
    Int i;

    if (((xdc_runtime_Startup_Module_State *)((&(xdc_runtime_Startup_Module__state__V))))->execFlag) {
        return;
    }

    ((xdc_runtime_Startup_Module_State *)((&(xdc_runtime_Startup_Module__state__V))))->execFlag = 1;

    for (i = 0; i < (xdc_runtime_Startup_firstFxns__C).length; i++) {
        (xdc_runtime_Startup_firstFxns__C).elem[i]();
    }

    ((xdc_runtime_Startup_execImpl__C))();

    for (i = 0; i < (xdc_runtime_Startup_lastFxns__C).length; i++) {
        (xdc_runtime_Startup_lastFxns__C).elem[i]();
    }
}
...
Bool xdc_runtime_Startup_rtsDone__E()
{
    return (((xdc_runtime_Startup_Module_State *)((&(xdc_runtime_Startup_Module__state__V))))->rtsDoneFlag);
}



 
void xdc_runtime_Startup_startMods__I__mangled__(Int state[], Int len)
{
    Int curPass;
    Int i;
    Bool done = 0;
    ...
    ((xdc_runtime_Startup_Module_State *)((&(xdc_runtime_Startup_Module__state__V))))->stateTab = state;

    for (i = 0; i < len; i++) {
        if ((xdc_runtime_Startup_sfxnRts__C)[i]) {
            state[i] = (xdc_runtime_Startup_sfxnTab__C)[i]((0));
        }
    }

    ((xdc_runtime_Startup_Module_State *)((&(xdc_runtime_Startup_Module__state__V))))->rtsDoneFlag = 1;

    for (curPass = 0; curPass < (xdc_runtime_Startup_maxPasses__C); curPass++) {
        done = 1;
        for (i = 0; i < len; i++) {
            if (state[i] != (-1)) {
                state[i] = (xdc_runtime_Startup_sfxnTab__C)[i](state[i]);
            }
            done &= (state[i] == (-1));
        }
        if (done) {
    ...
    if (!done) {
        xdc_runtime_System_abort__E("xdc.runtime.Startup: 'maxPasses' exceeded");
    }

    ((xdc_runtime_Startup_Module_State *)((&(xdc_runtime_Startup_Module__state__V))))->stateTab = 0;
}
