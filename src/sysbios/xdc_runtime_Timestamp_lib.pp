...
Bits32 xdc_runtime_Timestamp_get32__E()
{
...
void xdc_runtime_Timestamp_get64__E(xdc_runtime_Types_Timestamp64 *result)
{
...
void xdc_runtime_Timestamp_getFreq__E(xdc_runtime_Types_FreqHz *freq)
{
