...
Int ti_sysbios_family_arm_cc26xx_Timer_Module_startup__E(Int status)
{
...
void ti_sysbios_family_arm_cc26xx_Timer_startup__E()
{
    ti_sysbios_family_arm_cc26xx_Timer_Object *obj;
...
void ti_sysbios_family_arm_cc26xx_Timer_setPeriod__E(ti_sysbios_family_arm_cc26xx_Timer_Object *obj, UInt32 period)
{
    obj->period = period;
}
...
UInt32 ti_sysbios_family_arm_cc26xx_Timer_getPeriod__E(ti_sysbios_family_arm_cc26xx_Timer_Object *obj)
{
    return(obj->period);
}
...
void ti_sysbios_family_arm_cc26xx_Timer_periodicStub__E(UArg arg)
{
    UInt64 newThreshold;
    ti_sysbios_family_arm_cc26xx_Timer_Object *obj;
    Bool wrap = 0;
...
UInt32 ti_sysbios_family_arm_cc26xx_Timer_getExpiredTicks__E(ti_sysbios_family_arm_cc26xx_Timer_Object *obj, UInt32 tickPeriod)
{
    return (0);
}
...
Int ti_sysbios_family_arm_cc26xx_Timer_postInit__I (ti_sysbios_family_arm_cc26xx_Timer_Object *obj, xdc_runtime_Error_Block *eb)
{
    UInt key;
