...
void  ti_sysbios_gates_GateMutex_Instance_init__E(ti_sysbios_gates_GateMutex_Object *obj,
...
void ti_sysbios_gates_GateMutex_Instance_finalize__E(ti_sysbios_gates_GateMutex_Object *obj )
{
    ti_sysbios_knl_Semaphore_Handle sem;
...
IArg ti_sysbios_gates_GateMutex_enter__E(ti_sysbios_gates_GateMutex_Object *obj)
{
    ti_sysbios_knl_Semaphore_Handle sem;
...
void ti_sysbios_gates_GateMutex_leave__E(ti_sysbios_gates_GateMutex_Object *obj, IArg key)
{
    ti_sysbios_knl_Semaphore_Handle sem;
...
Bool ti_sysbios_gates_GateMutex_query__E(Int qual)
{
    return (1);
}
