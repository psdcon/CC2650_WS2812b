# 1 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Log.c"
...
# 17 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Log.c"
...
# 19 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Log.c"
...
# 20 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Log.c"
# 1 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Types.h"
...
# 21 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Log.c"

# 1 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Log.xdc.h"
...
# 16 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Log.xdc.h"

# 23 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Log.xdc.h"
...
# 77 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Log.xdc.h"


# 23 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Log.c"
...
# 40 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Log.c"




 
void xdc_runtime_Log_doPrint__E(xdc_runtime_Log_EventRec *er)
{
    ...
    if (er->serial) {
        xdc_runtime_System_printf__E("#%010u ", er->serial);
    }
    ...
    lo = er->tstamp.lo;
    if (lo != ~0 && hi != ~0) {
        xdc_runtime_System_printf__E("[t=0x");
        if (hi) {
            xdc_runtime_System_printf__E("%0.8x:", hi);
        }
        xdc_runtime_System_printf__E("%0.8x] ", lo);
    }

     
    xdc_runtime_Text_putMod__E((xdc_runtime_Text_RopeId)((er->evt) & 0x0000ffff), 0, -1);
    xdc_runtime_System_printf__E(": ");

     
    rope = ( (xdc_runtime_Types_RopeId)((er->evt) >> 16));    
    if (rope == 0) {
         
        xdc_runtime_System_aprintf__E((String)xdc_iargToPtr(er->arg[0]),
            er->arg[1], er->arg[2], er->arg[3], er->arg[4], 
            er->arg[5], er->arg[6], 0, 0);
    }
    else if (!(xdc_runtime_Text_isLoaded__C)) {
        

 
        xdc_runtime_System_aprintf__E("{evt: %d, args=[0x%x, 0x%x ...]}", rope, er->arg[0],
            er->arg[1]);
    }
    else {
         
        fmt = xdc_runtime_Text_ropeText__E(rope);
        xdc_runtime_System_aprintf__E(fmt, er->arg[0], er->arg[1], er->arg[2], er->arg[3],
