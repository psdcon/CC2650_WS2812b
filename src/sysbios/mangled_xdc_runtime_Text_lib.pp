# 1 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Text.c"
...
# 51 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/System.h"
...
# 53 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/System.h"
...
# 18 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Text.c"
# 1 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Types.h"
...
# 19 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Text.c"
...
# 304 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Registry.h"
...
# 341 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Registry.h"
...
# 20 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Text.c"
...
#pragma diag_pop
# 22 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Text.c"
# 1 "C:/ti/ccsv6/tools/compiler/ti-cgt-arm_15.12.1.LTS/include/stdarg.h"
...
# 117 "C:/ti/ccsv6/tools/compiler/ti-cgt-arm_15.12.1.LTS/include/stdarg.h"
...
#pragma diag_pop
# 23 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Text.c"

# 1 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Text.xdc.h"
...
# 457 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Text.h"
...
# 16 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Text.xdc.h"

# 23 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Text.xdc.h"
...
# 117 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Text.xdc.h"


# 25 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Text.c"
...
String xdc_runtime_Text_cordText__E__mangled__(xdc_runtime_Text_CordAddr cord)
{
    Char *p = (Char *)cord;

    if (p >= (xdc_runtime_Text_charTab__C) && p < (xdc_runtime_Text_charTab__C) + (xdc_runtime_Text_charCnt__C)
...
Int xdc_runtime_Text_matchRope__E(xdc_runtime_Types_RopeId rope, CString pat, Int *lenp)
{
    xdc_runtime_Text_MatchVisState state;
    ...
    (xdc_runtime_Text_visitRopeFxn__C)(rope, (Fxn)xdc_runtime_Text_matchVisFxn__I, &state);
...
Bool xdc_runtime_Text_matchVisFxn__I(Ptr obj, CString src)
{
    xdc_runtime_Text_MatchVisState *state;
    CString pat;
    Int *lenp;
...
Bool xdc_runtime_Text_printVisFxn__I(Ptr obj, CString src)
{
    xdc_runtime_Text_PrintVisState *state = obj;

    if (state->len == 0) {
        return (1);
    }
    else {
        Int oc = xdc_runtime_Text_xprintf__I(state->bufp, state->len, "%s", src);
        state->res += oc;
        if (state->len > 0) {
            state->len -= oc;
        }
...
Int xdc_runtime_Text_putLab__E(xdc_runtime_Types_Label *lab, Char **bufp, Int len)
{
    Int res;

    res = xdc_runtime_Text_putMod__E(lab->modId, bufp, len);
     
    if (len < 0 || (len - res) > (8 + 1)) {
        res += xdc_runtime_Text_xprintf__I(bufp, (len - res), "%p", lab->handle);
    }

    if (lab->named
        && (len < 0 || (len - res) >= (5 + (Int)strlen(lab->iname))) ) {
        res += xdc_runtime_Text_xprintf__I(bufp, (len - res), "('%s')", lab->iname);
    }
...
Int xdc_runtime_Text_putMod__E(xdc_runtime_Types_ModuleId mid, Char **bufp, Int len)
{
    xdc_runtime_Text_PrintVisState state;

     
    if (mid <= (xdc_runtime_Text_unnamedModsLastId__C)) {
        return (xdc_runtime_Text_xprintf__I(bufp, len, "{module#%d}", mid));
    }

     
    if (mid <= (xdc_runtime_Text_registryModsLastId__C)) {
        return (xdc_runtime_Text_xprintf__I(bufp, len, xdc_runtime_Registry_findById__E(mid)->modName));
    }

     
    if (!(xdc_runtime_Text_isLoaded__C)) {
        return (xdc_runtime_Text_xprintf__I(bufp, len, "{module-rope:%x}", mid));
    }
    else {
         
        state.bufp = bufp;
        state.len = len < 0 ? 0x7fff : len;    
        state.res = 0;

        (xdc_runtime_Text_visitRopeFxn__C)(mid, (Fxn)xdc_runtime_Text_printVisFxn__I, &state);
...
Int xdc_runtime_Text_putSite__E(xdc_runtime_Types_Site *site, Char **bufp, Int len)
{
    Int res;
    Int max = len < 0 ? 0x7fff : len;    
    ...
    if (site->mod != 0) {
        res = xdc_runtime_Text_putMod__E(site->mod, bufp, max);
    }

    if ((max - res) > 0) {
         
        if (site->mod != 0) {
            res += xdc_runtime_Text_xprintf__I(bufp, (max - res), ": ");
        }
        ...
        if (site->file && ((max - res) >= ((Int)strlen(site->file) + 5))) {
            res += xdc_runtime_Text_xprintf__I(bufp, (max - res), "\"%s\", ", site->file);
        }

        
 
        if ((max - res) >= (8 + 10)) {
            res += xdc_runtime_Text_xprintf__I(bufp, (max - res), "line %d: ", site->line);
        }
    }
...
String xdc_runtime_Text_ropeText__E__mangled__(xdc_runtime_Text_RopeId rope)
{
    return (rope & 0x8000 ? 0 : (xdc_runtime_Text_charTab__C) + rope);
}
...
void xdc_runtime_Text_visitRope2__I(xdc_runtime_Text_RopeId rope, Fxn visFxn, Ptr visState, String stack[])
{
    Int tos = 0;

    for (;;) {
        xdc_runtime_Text_Node *node;
        UInt16 index;
        String s = xdc_runtime_Text_ropeText__E(rope);
        if (s) {
            stack[tos++] = s;
            break;
        }
        index = rope & 0x7fff;
        node = (xdc_runtime_Text_nodeTab__C) + index;
        stack[tos++] = xdc_runtime_Text_ropeText__E(node->right);
        rope = node->left;
    }

    do {
        String s = stack[--tos];
        if (((xdc_runtime_Text_RopeVisitor)visFxn)(visState, s)) {
            return;
        }
    } while (tos);
}
...
Int xdc_runtime_Text_xprintf__I(Char **bufp, SizeT len, CString fmt, ...)
{
    va_list va;
    Char *b;
    Int res;

    ((va). __ap = ((void *)((((int)__va_parmadr(fmt))&~3) + (((sizeof(fmt)) + 3) & ~3))));
    b = (bufp && *bufp) ? *bufp : 0;

    res = xdc_runtime_System_vsnprintf__E(b, len, fmt, va);
