# 1 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Error.c"
...
# 51 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Gate.h"
...
# 53 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Gate.h"
...
# 18 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Error.c"
...
# 19 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Error.c"
...
# 20 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Error.c"
# 1 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Types.h"
...
# 21 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Error.c"
# 1 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Diags.h"
...
# 22 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Error.c"
...
# 23 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Error.c"
...
#pragma diag_pop
# 25 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Error.c"

# 1 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Error.xdc.h"
...
# 16 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Error.xdc.h"

# 23 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Error.xdc.h"
...
# 126 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/Error.xdc.h"


# 27 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Error.c"



 
void xdc_runtime_Error_init__E__mangled__(xdc_runtime_Error_Block *eb)
{
    if (eb) {
        memset(eb, 0, sizeof (xdc_runtime_Error_Block));
    }
}
...
Bool xdc_runtime_Error_check__E__mangled__(xdc_runtime_Error_Block *eb)
{
    return ((xdc_runtime_Error_policy__C) == xdc_runtime_Error_UNWIND && eb != 0 && eb->id != 0);
}
...
UInt16 xdc_runtime_Error_getCode__E(xdc_runtime_Error_Block *eb)
{
    return ((xdc_UInt16)((eb->id) & 0x0000ffff));
}
...
String xdc_runtime_Error_getMsg__E(xdc_runtime_Error_Block *eb)
{
    return (eb->msg);
}
...
void xdc_runtime_Error_print__E(xdc_runtime_Error_Block *eb)
{
    if (eb == 0) {
        return;
    }
    ...
    if (eb->msg) {
        xdc_runtime_Text_putSite__E(xdc_runtime_Error_getSite__E(eb), 0, -1);
        if ((xdc_runtime_Text_isLoaded__C)) {
            xdc_runtime_System_aprintf__E(eb->msg, eb->data.arg[0], eb->data.arg[1]);
        }
        else {
            xdc_runtime_System_aprintf__E("error {id:0x%x, args:[0x%x, 0x%x]}",
...
void xdc_runtime_Error_raiseX__E__mangled__(xdc_runtime_Error_Block *eb, xdc_runtime_Types_ModuleId mod, CString file, 
    Int line, xdc_runtime_Error_Id id, IArg arg1, IArg arg2)
{
    (xdc_runtime_Error_policyFxn__C)(eb, mod, file, line, id, arg1, arg2);
}



 
void xdc_runtime_Error_policyDefault__E(xdc_runtime_Error_Block *eb, xdc_runtime_Types_ModuleId mod, CString file, 
    Int line, xdc_runtime_Error_Id id, IArg arg1, IArg arg2)
{
    xdc_runtime_Error_Block defErr;
    IArg gateKey;
    UInt16 oldCount;
    ...
    xdc_runtime_Error_setX__E(eb, mod, file, line, id, arg1, arg2);
    ...
    if (xdc_runtime_Error_Module__loggerDefined__C && (xdc_runtime_Error_Module__diagsIncluded__C & ((xdc_runtime_Log_L_error__C)) && (xdc_runtime_Error_Module__diagsEnabled__C & ((xdc_runtime_Log_L_error__C)) || *xdc_runtime_Error_Module__diagsMask__C & ((xdc_runtime_Log_L_error__C))))) {   
        ;
    ...
    oldCount = ((xdc_runtime_Error_Module_State *)((&(xdc_runtime_Error_Module__state__V))))->count;
    ((xdc_runtime_Error_Module_State *)((&(xdc_runtime_Error_Module__state__V))))->count++;
    xdc_runtime_Gate_leaveSystem__E(gateKey);

     
    if ((xdc_runtime_Error_raiseHook__C) != 0 && oldCount < (xdc_runtime_Error_maxDepth__C)) {
        ((xdc_runtime_Error_raiseHook__C))(eb);
    }

    if ((xdc_runtime_Error_policy__C) == xdc_runtime_Error_TERMINATE || eb == &defErr) {
        xdc_runtime_System_abort__E("xdc.runtime.Error.raise: terminating execution\n");
    }
...
void xdc_runtime_Error_policySpin__E__mangled__(xdc_runtime_Error_Block *eb, xdc_runtime_Types_ModuleId mod, CString file, 
    Int line, xdc_runtime_Error_Id id, IArg arg1, IArg arg2)
{
    for(;;) {
    }
...
void xdc_runtime_Error_setX__E(xdc_runtime_Error_Block *eb, xdc_runtime_Types_ModuleId mod, CString file, 
    Int line, xdc_runtime_Error_Id id, IArg arg1, IArg arg2)
{
    ...
    eb->data.arg[1] = arg2;
    eb->id = id;
    eb->msg = (xdc_runtime_Text_isLoaded__C) ? xdc_runtime_Text_ropeText__E((xdc_runtime_Text_RopeId)(id >> 16)) : "";
    eb->site.mod = mod;
    eb->site.file = file;
    eb->site.line = line;
}
