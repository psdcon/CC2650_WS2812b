...
Ptr xdc_runtime_Memory_alloc__E(xdc_runtime_IHeap_Handle heap, SizeT size, SizeT align, xdc_runtime_Error_Block *eb)
{
    Ptr block;
...
Ptr xdc_runtime_Memory_calloc__E(xdc_runtime_IHeap_Handle heap, SizeT size, SizeT align, xdc_runtime_Error_Block *eb)
{
...
SizeT xdc_runtime_Memory_getMaxDefaultTypeAlign__E(void)
{
...
void xdc_runtime_Memory_free__E(xdc_runtime_IHeap_Handle heap, Ptr block, SizeT size)
{
...
Ptr xdc_runtime_Memory_valloc__E(xdc_runtime_IHeap_Handle heap, SizeT size, SizeT align, Char value, 
