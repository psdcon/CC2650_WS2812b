...
Int ti_sysbios_knl_Clock_Module_startup__E(Int phase)
{
...
UInt32 ti_sysbios_knl_Clock_getTicks__E()
{
...
ti_sysbios_knl_Clock_TimerProxy_Handle ti_sysbios_knl_Clock_getTimerHandle__E()
{
...
void ti_sysbios_knl_Clock_scheduleNextTick__E(UInt32 deltaTicks, UInt32 absTick)
{
...
void ti_sysbios_knl_Clock_workFunc__E(UArg arg0, UArg arg1)
{
    ti_sysbios_knl_Queue_Elem  *elem;
    UInt hwiKey, count;
    UInt32 time, compare;
...
UInt32 ti_sysbios_knl_Clock_walkQueueDynamic__E(Bool service, UInt32 thisTick)
{
    UInt32 distance = ~0;
    ti_sysbios_knl_Queue_Handle clockQ;
    ti_sysbios_knl_Queue_Elem  *elem;
...
void ti_sysbios_knl_Clock_Instance_init__E(ti_sysbios_knl_Clock_Object *obj, ti_sysbios_knl_Clock_FuncPtr func, UInt timeout,
...
void ti_sysbios_knl_Clock_Instance_finalize__E(ti_sysbios_knl_Clock_Object *obj)
{
    UInt key;
...
void ti_sysbios_knl_Clock_addI__E(ti_sysbios_knl_Clock_Object *obj, ti_sysbios_knl_Clock_FuncPtr func, UInt32 timeout, UArg arg)
{
    ti_sysbios_knl_Queue_Handle clockQ;
...
void ti_sysbios_knl_Clock_removeI__E(ti_sysbios_knl_Clock_Object *obj)
{
    ti_sysbios_knl_Queue_remove__E(&obj->elem);
}
...
void ti_sysbios_knl_Clock_startI__E(ti_sysbios_knl_Clock_Object *obj)
{
    if (ti_sysbios_knl_Clock_TickMode_DYNAMIC == ti_sysbios_knl_Clock_TickMode_DYNAMIC) {
...
void ti_sysbios_knl_Clock_start__E(ti_sysbios_knl_Clock_Object *obj)
{
    UInt key;
...
void ti_sysbios_knl_Clock_stop__E(ti_sysbios_knl_Clock_Object *obj)
{
    obj->active = 0;
}
...
void ti_sysbios_knl_Clock_setTimeout__E(ti_sysbios_knl_Clock_Object *obj, UInt32 timeout)
{
    obj->timeout = timeout;
}
...
void ti_sysbios_knl_Clock_logTick__E()
{
    ;
}
