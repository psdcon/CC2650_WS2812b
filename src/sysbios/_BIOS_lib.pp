...
ti_sysbios_BIOS_ThreadType ti_sysbios_BIOS_setThreadType__E(ti_sysbios_BIOS_ThreadType ttype)
{
...
void ti_sysbios_BIOS_getCpuFreq__E(xdc_runtime_Types_FreqHz *freq)
{
...
void ti_sysbios_BIOS_start__E(void)
{
...
void ti_sysbios_BIOS_exit__E(Int stat)
{
