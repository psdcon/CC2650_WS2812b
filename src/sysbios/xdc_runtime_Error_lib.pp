...
void xdc_runtime_Error_init__E(xdc_runtime_Error_Block *eb)
{
    if (eb) {
...
Bool xdc_runtime_Error_check__E(xdc_runtime_Error_Block *eb)
{
...
void xdc_runtime_Error_raiseX__E(xdc_runtime_Error_Block *eb, xdc_runtime_Types_ModuleId mod, CString file, 
...
void xdc_runtime_Error_policySpin__E(xdc_runtime_Error_Block *eb, xdc_runtime_Types_ModuleId mod, CString file, 
    Int line, xdc_runtime_Error_Id id, IArg arg1, IArg arg2)
{
    for(;;) {
    }
