...
Ptr xdc_runtime_Core_constructObject__I(const xdc_runtime_Core_ObjDesc *od, Ptr curObj, Ptr resPrms,
...
void xdc_runtime_Core_destructObject__I(const xdc_runtime_Core_ObjDesc *od, Ptr curObj, Fxn finalFxn,
