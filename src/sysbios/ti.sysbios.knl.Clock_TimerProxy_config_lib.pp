...
void ti_sysbios_knl_Clock_TimerProxy_startup__E( void )
{
...
void ti_sysbios_knl_Clock_TimerProxy_setNextTick__E( ti_sysbios_knl_Clock_TimerProxy_Handle __inst, xdc_UInt32 ticks )
{
