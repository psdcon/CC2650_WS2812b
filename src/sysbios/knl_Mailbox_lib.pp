...
Int ti_sysbios_knl_Mailbox_Module_startup__E(Int phase)
{
    Int i;
    SizeT blockSize;
...
Int ti_sysbios_knl_Mailbox_Instance_init__E(ti_sysbios_knl_Mailbox_Object *obj, SizeT msgSize,
...
void ti_sysbios_knl_Mailbox_Instance_finalize__E(ti_sysbios_knl_Mailbox_Object *obj, Int status)
{
    ti_sysbios_knl_Queue_Handle freeQue;
    ti_sysbios_knl_Queue_Handle dataQue;
    ti_sysbios_knl_Semaphore_Handle dataSem, freeSem;
...
Bool ti_sysbios_knl_Mailbox_pend__E(ti_sysbios_knl_Mailbox_Object *obj, Ptr msg, UInt32 timeout)
{
...
Bool ti_sysbios_knl_Mailbox_post__E(ti_sysbios_knl_Mailbox_Object *obj, Ptr msg, UInt32 timeout)
{
    ti_sysbios_knl_Mailbox_MbxElem *elem;
    ti_sysbios_knl_Queue_Handle dataQue;
    ti_sysbios_knl_Queue_Handle freeQue;
...
Int ti_sysbios_knl_Mailbox_postInit__I(ti_sysbios_knl_Mailbox_Object *obj, SizeT blockSize)
{
    Int i;
    ti_sysbios_knl_Queue_Handle freeQue;
    Char *buf = obj->buf;
