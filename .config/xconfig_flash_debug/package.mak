...
override PKGDIR = xconfig_flash_debug
...
package/%.xdc.inc package/%_xconfig_flash_debug.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_flash_debug" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em3 .dlls: flash_debug.pem3

-include package/cfg/flash_debug_pem3.mak
-include package/cfg/flash_debug_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/flash_debug_pem3.dep
endif
flash_debug.pem3: package/cfg/flash_debug_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
flash_debug.pem3 package/cfg/flash_debug_pem3.c: .libraries,em3
endif

package/cfg/flash_debug_pem3.c package/cfg/flash_debug_pem3.h package/cfg/flash_debug_pem3.xdl: override _PROG_NAME := flash_debug.xem3
package/cfg/flash_debug_pem3.c: package/cfg/flash_debug_pem3.cfg
package/cfg/flash_debug_pem3.xdc.inc: package/cfg/flash_debug_pem3.xdl
package/cfg/flash_debug_pem3.xdl package/cfg/flash_debug_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/flash_debug_pem3.cfg
	-$(RM) package/cfg/flash_debug_pem3.dep
	-$(RM) package/cfg/flash_debug_pem3.c
	-$(RM) package/cfg/flash_debug_pem3.xdc.inc

clean,em3::
	-$(RM) flash_debug.pem3
.executables,em3 .executables: flash_debug.xem3

flash_debug.xem3: |flash_debug.pem3

-include package/cfg/flash_debug.xem3.mak
flash_debug.xem3: package/cfg/flash_debug_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armlnk -w -q -u _c_int00  -q -o $@ package/cfg/flash_debug_pem3.oem3   package/cfg/flash_debug_pem3.xdl --silicon_version=7M3 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
flash_debug.xem3: export C_DIR=
flash_debug.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
flash_debug.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

flash_debug.test test,em3 test: flash_debug.xem3.test

flash_debug.xem3.test:: flash_debug.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 flash_debug.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.flash_debug.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,flash_debug.xem3,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
flash_debug_pem3.oem3,copy : package/cfg/flash_debug_pem3.oem3
flash_debug_pem3.sem3,copy : package/cfg/flash_debug_pem3.sem3

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_flash_debug
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_flash_debug.tar.dep
endif
package/rel/xconfig_flash_debug/xconfig_flash_debug/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_flash_debug/xconfig_flash_debug/package/package.rel.xml: package/build.cfg
package/rel/xconfig_flash_debug/xconfig_flash_debug/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_flash_debug/xconfig_flash_debug/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_flash_debug.tar: package/rel/xconfig_flash_debug.xdc.inc package/rel/xconfig_flash_debug/xconfig_flash_debug/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_flash_debug.xdc.inc,package/rel/xconfig_flash_debug.tar.dep)


release release,xconfig_flash_debug: all xconfig_flash_debug.tar
clean:: .clean
	-$(RM) xconfig_flash_debug.tar
	-$(RM) package/rel/xconfig_flash_debug.xdc.inc
	-$(RM) package/rel/xconfig_flash_debug.tar.dep
