...
override PKGDIR = xconfig_rom_release
...
package/%.xdc.inc package/%_xconfig_rom_release.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_rom_release" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em3 .dlls: rom_release.pem3

-include package/cfg/rom_release_pem3.mak
-include package/cfg/rom_release_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/rom_release_pem3.dep
endif
rom_release.pem3: package/cfg/rom_release_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
rom_release.pem3 package/cfg/rom_release_pem3.c: .libraries,em3
endif

package/cfg/rom_release_pem3.c package/cfg/rom_release_pem3.h package/cfg/rom_release_pem3.xdl: override _PROG_NAME := rom_release.xem3
package/cfg/rom_release_pem3.c: package/cfg/rom_release_pem3.cfg
package/cfg/rom_release_pem3.xdc.inc: package/cfg/rom_release_pem3.xdl
package/cfg/rom_release_pem3.xdl package/cfg/rom_release_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/rom_release_pem3.cfg
	-$(RM) package/cfg/rom_release_pem3.dep
	-$(RM) package/cfg/rom_release_pem3.c
	-$(RM) package/cfg/rom_release_pem3.xdc.inc

clean,em3::
	-$(RM) rom_release.pem3
.executables,em3 .executables: rom_release.xem3

rom_release.xem3: |rom_release.pem3

-include package/cfg/rom_release.xem3.mak
rom_release.xem3: package/cfg/rom_release_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armlnk -w -q -u _c_int00  -q -o $@ package/cfg/rom_release_pem3.oem3   package/cfg/rom_release_pem3.xdl --silicon_version=7M3 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
rom_release.xem3: export C_DIR=
rom_release.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
rom_release.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

rom_release.test test,em3 test: rom_release.xem3.test

rom_release.xem3.test:: rom_release.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 rom_release.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.rom_release.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,rom_release.xem3,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
rom_release_pem3.oem3,copy : package/cfg/rom_release_pem3.oem3
rom_release_pem3.sem3,copy : package/cfg/rom_release_pem3.sem3

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_rom_release
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_rom_release.tar.dep
endif
package/rel/xconfig_rom_release/xconfig_rom_release/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_rom_release/xconfig_rom_release/package/package.rel.xml: package/build.cfg
package/rel/xconfig_rom_release/xconfig_rom_release/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_rom_release/xconfig_rom_release/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_rom_release.tar: package/rel/xconfig_rom_release.xdc.inc package/rel/xconfig_rom_release/xconfig_rom_release/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_rom_release.xdc.inc,package/rel/xconfig_rom_release.tar.dep)


release release,xconfig_rom_release: all xconfig_rom_release.tar
clean:: .clean
	-$(RM) xconfig_rom_release.tar
	-$(RM) package/rel/xconfig_rom_release.xdc.inc
	-$(RM) package/rel/xconfig_rom_release.tar.dep
